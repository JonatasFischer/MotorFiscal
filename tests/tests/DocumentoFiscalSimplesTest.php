 ...
 */
class DocumentoFiscalSimplesTest extends TestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $operacao->setCFOPMercadoria(1);
        $operacao->setCFOPMercadoriaST(1);
        $operacao->setCFOPMercadoriaSTSubstituido(2);
        $operacao->setCFOPProduto(1);
        $operacao->setCFOPProdutoST(1);
