...
class Trib
{
    public static function IPI($prod, $oper, $emit, $dest)
    {
        $ipitrib             = [];
        $config              = new stdClass();
        $config->CST         = '00';
    ...
    public static function PIS($prod, $oper, $emit, $dest)
    {
        $config              = new stdClass();
        $config->CST         = '01';
    ...
    public static function COFINS($prod, $oper, $emit, $dest)
    {
        $config                 = new stdClass();
        $config->CST            = '01';
    ...
    public static function ICMS($prod, $oper, $emit, $dest)
    {
        $icmstrib = [];
